...
//             visitor functions
//----------------------------------------------------------------------
void LIRGenerator::do_StoreIndexed(StoreIndexed* x) {  assert(x->is_pinned(),"");
...
// There is no _fmaD/_fmaF in JDK8.
...
void LIRGenerator::do_If(If* x) {
  ...
  if (x->is_safepoint()) {
    // increment backedge counter if needed,but there is no increment_backedge_counter_conditionally in JDK8
