...
class LIR_Assembler: public CompilationResourceObj {
 ...
 public:
  ...
  NO_FLAGREG_ONLY(void emit_op4(LIR_Op4* op);)
  ...
  void leal(LIR_Opr addr, LIR_Opr dest, LIR_PatchCode patch_code, CodeEmitInfo* info);
...
# include "c1_LIRAssembler_riscv64.hpp"
#endif
